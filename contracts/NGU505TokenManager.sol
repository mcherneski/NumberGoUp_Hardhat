...
abstract contract NGU505TokenManager is NGU505Base, INGU505TokenManager {
    ...
    function stakeNFT(uint256 id_) public virtual override nonReentrant returns (bool) {
        ...
        if (balanceOf[msg.sender] < units) revert ManagerInsufficientBalance();
    ...
    function unstakeNFT(uint256 id_) public virtual override nonReentrant returns (bool) {
        ...
        if (stakedBalance < units) revert ManagerInsufficientBalance();
    ...
    function stakeMultipleNFTs(uint256[] calldata ids_) public virtual override nonReentrant returns (bool) {
        ...
        if (balanceOf[msg.sender] < totalStakeAmount) revert ManagerInsufficientBalance();
    ...
    // Add these functions to NGU505TokenManager
